...
// DATA
// ────────────────────────────────────────────────────────────
// 48 real cartones, transcribed from photos of the physical cards.
// Each card: 3 rows × 9 columns (col ranges 1-9,10-19,…,80-90); 5 numbers per row; 0 = blank.
// The card's ID number sits in the top-left circle (row 1, col 0) so that cell is never a playable number.
const CARTONES = [
  {id:1,rows:[[0,0,0,32,0,50,61,72,84],[1,0,20,0,45,57,0,0,90],[9,0,23,0,43,51,62,0,0]]},
  {id:2,rows:[[0,0,0,31,47,0,66,70,83],[6,10,22,0,40,0,63,0,0],[0,17,0,38,0,56,0,77,82]]},
  {id:3,rows:[[0,0,0,35,48,53,0,71,87],[2,13,27,0,41,0,0,0,89],[5,15,0,30,0,55,0,74,0]]},
  {id:4,rows:[[0,0,0,33,42,0,64,75,80],[3,12,21,0,0,54,60,0,0],[0,19,28,37,0,0,0,78,86]]},
  {id:5,rows:[[0,0,0,36,49,0,68,73,88],[8,16,25,0,44,0,0,76,0],[0,14,29,0,0,52,69,0,85]]},
  {id:6,rows:[[0,0,0,34,46,59,65,0,81],[7,18,26,0,0,58,0,79,0],[4,11,24,39,0,0,67,0,0]]},
  {id:7,rows:[[0,0,27,0,41,54,63,0,87],[6,11,0,37,46,0,62,0,0],[1,15,22,0,0,52,0,70,0]]},
  {id:8,rows:[[0,0,25,0,42,57,0,71,90],[8,19,0,32,0,0,64,0,83],[0,10,21,35,0,59,0,76,0]]},
  {id:9,rows:[[0,0,26,0,47,0,67,73,86],[5,0,20,0,0,53,0,72,81],[0,0,0,33,0,51,60,77,84]]},
  {id:10,rows:[[0,0,0,30,40,55,0,79,89],[4,18,0,34,44,58,0,0,0],[0,14,0,0,49,50,69,0,88]]},
  {id:11,rows:[[0,0,29,0,43,0,61,75,82],[3,13,24,0,48,0,65,0,0],[9,17,0,36,45,0,0,78,0]]},
  {id:12,rows:[[0,0,28,38,0,0,66,74,85],[2,12,23,31,0,56,0,0,0],[7,16,0,39,0,0,68,0,80]]},
  {id:13,rows:[[0,0,0,39,0,52,68,72,82],[0,18,23,30,0,0,63,76,0],[9,12,27,0,0,51,0,0,86]]},
  {id:14,rows:[[0,0,0,0,41,54,60,71,90],[8,16,0,35,43,0,64,0,0],[3,0,22,31,0,56,0,73,0]]},
  {id:15,rows:[[0,0,0,0,40,53,61,74,83],[0,15,21,32,46,58,0,0,0],[2,11,29,0,44,0,0,0,80]]},
  {id:16,rows:[[0,0,0,0,42,55,66,70,85],[4,17,20,34,0,0,0,0,87],[6,19,24,0,0,50,0,0,88]]},
  {id:17,rows:[[0,0,0,38,45,0,69,75,89],[0,13,25,0,47,57,62,0,0],[7,10,0,36,0,0,0,79,84]]},
  {id:18,rows:[[0,0,0,37,49,0,65,77,81],[5,14,26,0,48,0,0,78,0],[1,0,28,33,0,59,67,0,0]]},
  {id:19,rows:[[0,0,0,0,45,54,63,75,90],[3,19,0,31,0,0,67,0,82],[0,10,28,0,40,55,0,77,0]]},
  {id:20,rows:[[0,0,0,0,46,52,60,78,80],[7,13,27,34,0,0,0,72,0],[2,17,22,36,0,0,0,0,81]]},
  {id:21,rows:[[0,0,0,0,48,51,64,76,83],[0,15,23,35,0,57,0,0,87],[8,16,29,32,41,0,0,0,0]]},
  {id:22,rows:[[0,0,0,0,43,50,62,73,89],[0,11,21,37,0,0,61,0,84],[5,18,0,30,42,0,0,70,0]]},
  {id:23,rows:[[0,12,20,33,0,56,0,0,85],[4,0,26,0,47,0,65,71,0],[9,0,0,38,0,59,68,0,88]]},
  {id:24,rows:[[0,0,0,0,44,53,66,79,86],[6,14,24,0,49,0,69,0,0],[1,0,25,39,0,58,0,74,0]]},
  {id:25,rows:[[0,0,0,33,0,51,62,73,85],[2,0,21,0,46,58,0,0,81],[1,0,24,0,44,52,63,0,0]]},
  {id:26,rows:[[0,0,0,32,48,0,67,71,84],[7,11,23,0,41,0,64,0,0],[0,18,0,39,0,57,0,78,83]]},
  {id:27,rows:[[0,0,0,36,49,54,0,72,88],[3,14,28,0,42,0,0,0,90],[6,16,0,31,0,56,0,75,0]]},
  {id:28,rows:[[0,0,0,34,43,0,65,76,81],[4,13,22,0,0,55,61,0,0],[0,10,29,38,0,0,0,79,87]]},
  {id:29,rows:[[0,0,0,37,41,0,69,74,89],[9,17,26,0,45,0,0,77,0],[0,15,21,0,0,53,60,0,86]]},
  {id:30,rows:[[0,0,0,35,47,50,66,0,82],[8,19,27,0,0,59,0,70,0],[5,12,25,30,0,0,68,0,0]]},
  {id:31,rows:[[0,0,28,0,42,55,64,0,88],[7,12,0,38,47,0,63,0,0],[2,16,23,0,0,53,0,71,0]]},
  {id:32,rows:[[0,0,26,0,43,58,0,72,80],[9,10,0,33,0,0,65,0,84],[0,11,22,36,0,50,0,77,0]]},
  {id:33,rows:[[0,0,27,0,48,0,68,74,87],[6,0,21,0,0,54,0,73,82],[0,0,0,34,0,52,61,78,85]]},
  {id:34,rows:[[0,0,0,31,41,56,0,71,90],[5,19,0,35,45,59,0,0,0],[0,15,0,0,40,51,60,0,89]]},
  {id:35,rows:[[0,0,20,0,44,0,62,76,83],[4,14,25,0,49,0,66,0,0],[1,18,0,37,46,0,0,79,0]]},
  {id:36,rows:[[0,0,29,39,0,0,67,75,86],[3,13,24,32,0,57,0,0,0],[8,17,0,30,0,0,69,0,81]]},
  {id:37,rows:[[0,0,0,30,0,53,69,73,83],[0,19,24,31,0,0,64,77,0],[1,13,28,0,0,52,0,0,87]]},
  {id:38,rows:[[0,0,0,0,42,55,61,72,80],[9,17,0,36,44,0,65,0,0],[4,0,23,32,0,57,0,74,0]]},
  {id:39,rows:[[0,0,0,0,41,54,62,75,80],[0,16,22,33,47,59,0,0,0],[3,12,20,0,45,0,0,0,81]]},
  {id:40,rows:[[0,0,0,0,43,56,67,71,86],[5,18,21,35,0,0,0,0,88],[7,10,25,0,0,51,0,0,89]]},
  {id:41,rows:[[0,0,0,39,46,0,60,76,90],[0,14,26,0,48,58,63,0,0],[8,11,0,37,0,0,0,70,85]]},
  {id:42,rows:[[0,0,0,38,40,0,66,78,82],[6,15,27,0,49,0,0,79,0],[2,0,29,37,0,50,68,0,0]]},
  {id:43,rows:[[0,0,0,0,46,55,64,70,80],[4,10,0,32,0,0,68,0,83],[0,11,29,0,41,56,0,78,0]]},
  {id:44,rows:[[0,0,0,0,47,53,61,79,81],[8,14,28,35,0,0,0,73,0],[3,18,23,37,0,0,0,0,82]]},
  {id:45,rows:[[0,0,0,0,49,52,65,77,84],[0,16,24,36,0,58,0,0,88],[9,17,20,33,42,0,0,0,0]]},
  {id:46,rows:[[0,0,0,0,44,51,63,74,90],[0,12,22,38,0,0,62,0,85],[6,19,0,31,43,0,0,71,0]]},
  {id:47,rows:[[0,13,21,34,0,57,0,0,86],[5,0,27,0,48,0,66,72,0],[1,0,0,39,0,50,69,0,89]]},
  {id:48,rows:[[0,0,0,0,45,54,67,70,87],[7,15,25,0,40,0,60,0,0],[2,0,26,30,0,59,0,75,0]]},
];
...
const pickTopCartons = (takenIdxs, n) => {
  const out = [];
  for (let i = CARTONES.length - 1; i >= 0 && out.length < n; i--) if (!takenIdxs.includes(i)) out.push(i);
  return out;
};
    ...
    <div className="landing" style={{position:'relative'}}>
      ...
      <div className="cards-wrap">
        <div className="lc">
          ...
          <div className="fld">
            ...
            <input className="inp" value={cName} onChange={e => setCName(e.target.value)}
              placeholder="Ej: Juanito" onKeyDown={e => e.key === 'Enter' && cName.trim() && onCreate(cName.trim())} />
          </div>
        ...
        <div className="lc">
          ...
          <div className="fld">
            <label className="lbl">{t(lang,'yourName')}</label>
            <input className="inp" value={jName} onChange={e => setJName(e.target.value)} placeholder="Ej: Juanito" />
          </div>
